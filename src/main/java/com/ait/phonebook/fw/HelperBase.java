...
import com.ait.phonebook.utils.Recorder;
...
public class HelperBase {
    ...
    public boolean isAllertPresent() {
        Alert alert = new WebDriverWait(driver, 40)
    ...
    public void startRecording() throws IOException, AWTException {
        ...
        GraphicsConfiguration gс = GraphicsEnvironment
                .getLocalGraphicsEnvironment()
                .getDefaultScreenDevice()
                .getDefaultConfiguration();

                screenRecorder = new Recorder(gс, captureSize,
